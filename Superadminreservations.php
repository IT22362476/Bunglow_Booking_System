            ...
            <tbody id="reservation-list">
                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<td><a href="Sadmineditreservations.php?id=' . urlencode($row['invoicenumber']) . '" class="edit-btn">Edit</a></td>';
                        echo '<td><a href="Sadminremovereservations.php?id=' . urlencode($row['invoicenumber']) . '" class="remove-btn" onclick="return confirmDelete()">Delete</a></td>';
                        echo "</tr>";
                    }
                } else {
