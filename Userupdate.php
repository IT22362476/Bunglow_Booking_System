...
if (isset($_POST['update'])) {
    ...
    $stmt = mysqli_prepare($connection, $sql);
    mysqli_stmt_bind_param($stmt, 'isssi', $employeeID, $guestname, $email, $phone, $userID);

    if (mysqli_stmt_execute($stmt)) {
        echo "User updated successfully!";
        header("Location: your-table-page.php"); // Redirect back to the table page
        exit;
    } else {
    ...
    <form action="Updateuser.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="EmployeeID" id="EmployeeID"
                value="<?php echo htmlspecialchars($user['EmployeeID']); ?>" required>
        </div>
        <div class="form-group">
            <label for="Guestname">Guestname:</label>
            <input type="text" name="Guestname" id="Guestname"
                value="<?php echo htmlspecialchars($user['Guestname']); ?>" required>
        </div>
        <div class="form-group">
